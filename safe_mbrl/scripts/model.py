        ...
        for epoch in range(epochs):
            ...
            if (epoch+1) % self.test_freq == 0:
                ...
                if len(test_loader) > 0:
                    ...
                    print(f"training epoch [{epoch}/{epochs}],loss train: {loss_train:.4f}, loss test  {loss_test:.4f}")
                else:
                    print(f"training epoch [{epoch}/{epochs}],loss train: {loss_train:.4f}, no testing data")
